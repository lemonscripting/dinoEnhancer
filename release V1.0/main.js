...
<div class="navbar">
    <button onclick="showPage('page1')">Miscellaneous</button>
    <button onclick="showPage('page2')">Insane</button>
</div>
...
<div class="page" id="page1">
    ...
    <div class="menu-item">
        ...
        <label for="mod3">High Jump</label>
    </div>
...
<label for="mod4">Sprint</label>
</div>
    <div class="menu-item">
        <input type="checkbox" id="mod5">
        <label for="mod5">Auto Run</label>
    </div>
...
function handleCheckbox3Change() {
    if (document.getElementById('mod3').checked) {
        Runner.instance_.tRex.setJumpVelocity(18);
        console.log("high jump activated");
    } else {
        Runner.instance_.tRex.setJumpVelocity(10);
        console.log("high jump deactivated");
    }
}
...
document.getElementById('mod5').addEventListener('change', handleCheckbox5Change);